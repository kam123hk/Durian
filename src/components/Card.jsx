...
function Card({currentCard, setCurrentCard, setOrders, isDeckDisabled, setIsDeckDisabled, isGameOver, deck, setDeck, setIsComputerTurn, isComputerTurn, numberOfComputerPlayers, SingleRasp, DoubleRasp, TripleRasp, SingleStraw, DoubleStraw, TripleStraw, SingleBanana, DoubleBanana, TripleBanana, SingleDurian, DoubleDurian, TripleDurian}) {
